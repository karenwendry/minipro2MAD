...
export default function LoginScreen() {
  ...
  const handleSignup = () => {
    ...
    if (!identifier || !password || !confirmPassword) {
      Alert.alert('Error', 'All columns must be filled in');
      return;
    }
    ...
    Alert.alert(
      ...
      'Account Created Susccessfully. Please Login.'
    );
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            {isSignup ? 'Login to your account' : 'Login to your account'}
          </Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.label}>
            {loginType === 'mahasiswa' ? 'NIM / email' : 'ID Admin / Username'}
          </Text>
        ...
        <View style={styles.footerInfo}>
          <Text style={styles.footerText}>🔒 Secure & Encryptedd authentication</Text>
        </View>
